...
export default function HeaderUsers() {
	...
	const { isLoading, notification, handleBlocked, handleUnblocked, handleDelete } =
			...
			<div className="d-flex justify-content-between">
				<div className="d-flex align-items-start">
					<div className="d-flex flex-column me-2">
						...
						>
							<i className="bi bi-lock"></i> {isLoading ? "Blocking..." : "Block"}
						</button>
						{notification && (
							<div
					...
					<button
						...
						disabled={isLoading || !userId.length}
					>
						<i className="bi bi-unlock"></i> {isLoading ? "Unblocking..." : "Unblock"}
					</button>
					<button
						type="button"
						...
						disabled={isLoading || !userId.length}
					>
						<i className="bi bi-trash"></i> {isLoading ? "Deleting..." : "Delete"}
					</button>
				</div>
